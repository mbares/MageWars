...
public class FloatingTextController : MonoBehaviour {
    ...
    public static void Initialize() {
        ...
        floatingText = Resources.Load<FloatingText>("Prefabs/UI/FloatingTextParent");
    }

	public static void CreateFloatingText(string text, Transform location, Color textColor) {
